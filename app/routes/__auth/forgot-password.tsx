...
export async function action({ request }: ActionArgs) {
  ...
  const result = await ForgotPasswordSchema.safeParseAsync(parseFormAny(formData));
    ...
    <div className="flex flex-col justify-center min-h-full">
      <div className="w-full max-w-md px-8 mx-auto">
        {!actionData ? (
          ...
          <div className={tw(`mb-2 h-6 text-center`, actionData.message ? 'text-red-600' : 'text-green-600')}>
